...
// mongoose está sendo passada como parâmetro para mongoose-sequence
...
const esquema = mongoose.Schema({
   ...
   cliente: {
       ...
       ref: 'Cliente', //Nome do model referênciado
       required: true
   }
})

//inc_field: o campo a ser autoincrementado
//start_seq: o número que íra iniciar a contagem. default: 1
